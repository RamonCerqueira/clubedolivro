...
__decorate([
    (0, common_1.Patch)(':goalId/progress'),
    __param(0, (0, common_1.Param)('clubId')),
    __param(1, (0, common_1.Param)('goalId')),
    __param(2, (0, common_1.Body)('pages')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Number]),
    __metadata("design:returntype", void 0)
], GoalController.prototype, "addProgress", null);
__decorate([
...
exports.GoalController = GoalController = __decorate([
    (0, common_1.Controller)('clubs/:clubId/goals'),
